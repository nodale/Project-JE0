...
{
    std::ofstream output("output/systemFile/snappyHexMeshDict");
...
{
    std::ofstream cd("output/systemFile/controlDict");
    cd << "FoamFile\n"
    "{\n"
    "   version     2.0;\n"
    "   format      ascii;\n"
...
{
    std::ofstream output("output/systemFile/createPatchDict");
...
{
std::ofstream obj("output/stl/blade.obj");
